...
public class OARobotApplication extends Application {
    ...
    // 默认本地发音人
    public static String voicerLocal = "yiping";
    //缓冲进度
...
//                .addCommonParams(params);                      //全局公共参数
    ...
    private void initTTS() {
        ...
        //设置合成语速
        mTts.setParameter(SpeechConstant.SPEED, "50onm");
        //设置合成音调
        mTts.setParameter(SpeechConstant.PITCH, "65");
        //设置合成音量
        mTts.setParameter(SpeechConstant.VOLUME, isNeedVoice ? "0" : "90");
        //如果使用合成语音可以调25
...
//
    ...
    private String getRttsPath() {
        ...
        tempBuffer.append(";");
        //发音人资源
        tempBuffer.append(ResourceUtil.generateResourcePath(this, ResourceUtil.RESOURCE_TYPE.assets, "tts/yiping.jet"));

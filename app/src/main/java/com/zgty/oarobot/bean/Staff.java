...
public class Staff {
    ...
    @Generated(hash = 105486340)
    public Staff(Long ids, String id, String name_user, String id_user,
            String id_clerk, String name_part, String name_position,
            String call_num, String user_type, Boolean isRecordFace) {
        this.ids = ids;
        this.id = id;
